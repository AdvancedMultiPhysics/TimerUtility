...
// clang-format off
#ifndef PROFILE_DISABLE_WARNINGS
#if defined( _MSC_VER )
    #define PROFILE_DISABLE_WARNINGS __pragma( warning( push, 0 ) )
    #define PROFILE_ENABLE_WARNINGS __pragma( warning( pop ) )
#elif defined( __clang__ )
    #define PROFILE_DISABLE_WARNINGS                                              \
    ...
    #define PROFILE_ENABLE_WARNINGS _Pragma( "clang diagnostic pop" )
#elif defined( __INTEL_COMPILER )
    #if defined( __INTEL_LLVM_COMPILER )
        #define PROFILE_DISABLE_WARNINGS _Pragma( "warning (push)" )
        #define PROFILE_ENABLE_WARNINGS _Pragma( "warning(pop)" )
    #else
        #define PROFILE_DISABLE_WARNINGS      \
    ...
    #define PROFILE_ENABLE_WARNINGS _Pragma( "GCC diagnostic pop" )
#else
    #define PROFILE_DISABLE_WARNINGS
    #define PROFILE_ENABLE_WARNINGS
#endif
#endif
// clang-format on
