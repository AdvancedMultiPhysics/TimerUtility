...
MACRO( SET_CXX_STD )
    ...
    IF ( NOT CMAKE_CXX_STANDARD )
        IF ( CXX_STD )
            ...
            ELSEIF ( "${CXX_STD}" MATCHES "^(98|11|14|17)$" )
                MASSAGE( FATAL_ERROR "C++20 or newer required" )
    ...
    IF ( "${CMAKE_CXX_STANDARD}" MATCHES "17" )
        MESSAGE( MESSAGE "C++17 will be deprecated" )
    ELSEIF ( NOT ( "${CMAKE_CXX_STANDARD}" MATCHES "^(20|23|26)$" ) )
...
MACRO( CONFIGURE_TIMER )
    ...
    IF ( "${CMAKE_CXX_STANDARD}" MATCHES "17" )
        FILE( APPEND "${${PROJ}_INSTALL_DIR}/include/ProfilerDefinitions.h" "#define TIMER_CONSTEVAL constexpr\n" )
    ELSE()
        FILE( APPEND "${${PROJ}_INSTALL_DIR}/include/ProfilerDefinitions.h" "#define TIMER_CONSTEVAL consteval\n" )
    ENDIF()
