...
EXECUTE_PROCESS(
    COMMAND
        ${CMAKE_COMMAND} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} -DCMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS} -DCXX_STD=${CXX_STD}
        -DENABLE_GXX_DEBUG=${ENABLE_GXX_DEBUG} -DTIMER_INSTALL_DIR=${TIMER_INSTALL_DIR} -DQT_VERSION=${QT_VERSION} -DQWT_INSTALL_DIR=${QWT_INSTALL_DIR}
        -DTIMER_GUI_INSTALL_DIR=${GUI_INSTALL_DIR} ${TIMER_GUI_SOURCE_DIR}
