...
#
# find_package( Cppclean [REQUIRED]                # Fail with error if the cppclean is not found )
#
# This module finds cppclean and configures a test using the provided options
#
# This program reconizes the following options CPPCLEAN_INCLUDE            - List of include folders CPPCLEAN_OPTIONS            - List of cppclean options CPPCLEAN_EXCLUDE - List
# of files to exclude CPPCLEAN_SUPPRESSIONS - List of messages to suppress ( based on partial string matching ) CPPCLEAN_UNNECESSARY_INCLUDE- Enable warnings about unnecessary
# includes CPPCLEAN_EXTRA_INCLUDE      - Enable warnings about extra includes CPPCLEAN_SHOULD_INCLUDE     - Enable warnings about should includes CPPCLEAN_INCLUDE_NOT_FOUND  -
# Enable warnings about missing includes CPPCLEAN_FUN_NOT_FOUND      - Enable warnings about functions not found CPPCLEAN_DECLARED           - Enable warnings about declared but
# not defined CPPCLEAN_STATIC             - Enable warnings about static data CPPCLEAN_UNUSED_VARIABLE    - Enable warnings about unused variables CPPCLEAN_FORWARD_DECLARE    -
# Enable messages for forward decelerations CPPCLEAN_UNKNOWN            - Enable unknown messages CPPCLEAN_SOURCE - Source path to check CPPCLEAN_FAIL_ON_WARNINGS   - Cause the
# test to fail if warnings are detected ( default is false )
#
