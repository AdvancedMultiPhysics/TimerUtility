...
indicates the desired build type (Debug, Release).  
The final argument is the path to the source tree.
...
is currently written in QT and uses qwt.  To install a gui, first make sure that QT5
is installed.  The set the flags QT_VERSION=5 and QWT_URL for CMake.
