...
FUNCTION( CONFIGURE_LINE_COVERAGE )
    ...
    SET( COVERAGE_LIBS )
    IF ( ENABLE_GCOV )
        SET( COVERAGE_FLAGS -fprofile-arcs -ftest-coverage -DUSE_GCOV )
        SET( COVERAGE_LIBS -fprofile-arcs )
        CHECK_CXX_COMPILER_FLAG( -lgcov test1 )
        IF ( ${test1} )
            SET( COVERAGE_LIBS -lgcov ${COVERAGE_LIBS} )
        ENDIF()
        CHECK_CXX_COMPILER_FLAG( "${COVERAGE_FLAGS} ${COVERAGE_LIBS}" test2 )
        IF ( NOT ${test2} )
            MESSAGE( FATAL_ERROR "Unable to compile with coverage flags")
        ENDIF()
