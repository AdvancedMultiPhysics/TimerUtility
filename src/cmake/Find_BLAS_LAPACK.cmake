INCLUDE( ${ATOMIC_SOURCE_DIR}/cmake/BlasLapack/FindBLAS.cmake )
INCLUDE( ${ATOMIC_SOURCE_DIR}/cmake/BlasLapack/FindLAPACK.cmake )
...
FUNCTION( CONFIGURE_BLAS_AND_LAPACK )
    ...
    CHECK_ENABLE_FLAG( USE_BLAS   0 )
    CHECK_ENABLE_FLAG( USE_LAPACK 0 )
    # Write a file with the necessary includes for blas/lapack routines
    SET( BLAS_LAPACK_HEADER ${ATOMIC_INSTALL_DIR}/include/blas_lapack.h )
    ...
    ELSE()
        ...
        CONFIGURE_LAPACK()
        SET( BLAS_LAPACK_LIBS ${BLAS_LIBS} ${LAPACK_LIBS} PARENT_SCOPE)
        CONFIGURE_FILE( ${ATOMIC_SOURCE_DIR}/cmake/BlasLapack/fortran_calls.h ${ATOMIC_INSTALL_DIR}/include/fortran_calls.h COPYONLY )
