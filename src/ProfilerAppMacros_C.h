...
#define PROFILE_SAVE_GLOBAL(NAME,GLOB)                                  \
    global_profiler_save(NAME,GLOB)
...
#define PROFILE_STORE_TRACE(X) \
    global_profiler_set_store_trace( X )
...
#define PROFILE_ENABLE_TRACE() \
    global_profiler_set_store_trace(1)
...
#define PROFILE_DISABLE_TRACE() \
    global_profiler_set_store_trace(0)
...
#define PROFILE_ENABLE_MEMORY() \
    global_profiler_set_store_memory(1)
...
#define PROFILE_DISABLE_MEMORY() \
    global_profiler_set_store_memory(0)
