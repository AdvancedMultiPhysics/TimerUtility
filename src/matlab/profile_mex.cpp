...
void mexFunction(int nlhs, mxArray *[], int nrhs, const mxArray *prhs[])
{
    ...
    const char* msg = "Error, Incorrect number of inputs or outputs.\n"
            ...
            "      Enable/disable the memory trace data for the profiler (true: enable, false: disable)\n"
            "   profile_mex('SAVE',filename);\n"
            "      Save the current results of the profiler to the given file\n"
            "   profile_mex('START',name);\n"
            "      Start a timer for the given name (file and line are automatically gathered, level=0)\n"
            "   profile_mex('START',name,level);\n"
            "      Start a timer for the given name and level (file and line are automatically gathered)\n"
            "   profile_mex('START',name,file,line,level);\n"
            "      Start a timer for the given name, file, line number, and level\n"
            "   profile_mex('STOP',name);\n"
            "      Stop a timer for the given name (file and line are automatically gathered, level=0)\n"
            "   profile_mex('STOP',name,level);\n"
            "      Stop a timer for the given name and level (file and line are automatically gathered)\n"
