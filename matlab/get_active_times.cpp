...
template<class TYPE>
void search(
    size_t Nt, const TYPE *t, size_t Ns, const TYPE *start, const TYPE *stop, bool *active )
{
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] )
{
    ...
    if ( Ns == 0 ) {
        ...
        for ( size_t i = 0; i < Nt; i++ )
            data[i] = false;
    } else if ( t_id == mxDOUBLE_CLASS && start_id == mxDOUBLE_CLASS &&
                stop_id == mxDOUBLE_CLASS ) {
    ...
    } else if ( t_id == mxSINGLE_CLASS && start_id == mxSINGLE_CLASS &&
                stop_id == mxSINGLE_CLASS ) {
    ...
    } else if ( t_id == mxDOUBLE_CLASS && start_id == mxSINGLE_CLASS &&
                stop_id == mxSINGLE_CLASS ) {
